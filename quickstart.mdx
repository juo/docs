...
<AccordionGroup>
  <Accordion icon="github" title="Clone your docs locally">
    ...
    [instructions](https:/.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
    in your terminal.
  </Accordion>
...
<Accordion icon="rocket" title="Push your changes">
  ...
  Git](https:/.github.com/en/get-started/using-git/pushing-commits-to-a-remote-repository#about-git-push)
