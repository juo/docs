...
Before using Customer.io integration, enable it in the Juo admin panel under **Settings → Integrations → Customer.io**. You will need your Customer.io **Write Key** and region (EU or US).

## ID type

Choose how Juo identifies people in Customer.io:

| ID type | Profiles and events keyed by |
|---|---|
| **Email** | Customer email address |
| **Shopify customer ID** | Shopify customer ID |

Pick this before you go live. Changing ID type later creates **new** profiles under the new key instead of merging into existing ones.
