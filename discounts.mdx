...
You can set the eligibility of these discounts to all or just some purchase options. Use this to restrict eligibility by selling plan without giving up Shopify’s native discount codes and automatic discount rules.
...
5. **Tiered discounts (Juo)**

Volume / threshold discounts created in **Experiences → Tiered discounts**. They appear at cart and checkout, support percentage / fixed / set-price tiers, product or collection targeting, and subscription vs one-time eligibility. See [Tiered discounts](/tiered-discounts).

6. **Discounts applied in Admin**

From a subscription (or via [bulk actions](/bulk-actions)), you can add **Amount off subscription** or **Amount off products** for a set number of renewals or permanently — without creating a Shopify discount code.
...
To allow customers to enter discount codes in the Juo Customer Portal, enable **Redeem discount code** under **Settings → Customer Portal**. It’s disabled by default.
