...
You can choose between adding products and product variants to the selling plans
...
Next, it’s time decide to which cycles you want the discount to apply. (Refer back to the [product section above](https://juo.io/docs/subscribe-and-save#free-product) for more details on how the cycle selection works.
