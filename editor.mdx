...
The **Editor** is a visual customization tool available for admins and developers. Use it to design how subscribers see and interact with the [Customer Portal](/customer-portal).

## Editor layout

<Frame caption="The Block Editor: live preview in the center, block settings in the right sidebar">
  ![Block Editor interface showing a Customer Portal preview with the Banner block selected](/images/editor-block-editor.png)
</Frame>
...
Product recommendations carousel for add-ons, samples, and discounted items. Works with [Upsells](/upsells) configured in Admin.
...
Discount-related UI where configured for your shop. See [discounts](/discounts) for setup details.
