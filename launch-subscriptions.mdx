...
[Curated boxes](https://juo.io/docs/curated-boxes) are best if you’d like to to pick a product (or products) that go into each delivery month to month. Best for curated and mystery boxes, where you want to keep things fresh and not plan too far ahead.
