...
Use [Subscribe & Save](https://juo.io/docs/subscribe-and-save) to set up a classic subscription experience. A customer can opt in to subscribe to a product on the product page. Next orders will be created automatically at a frequency chosen by the customer in the subscription widget.
