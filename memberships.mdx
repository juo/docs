...
<Frame caption="Add a virtual parent product for your Membership">
  ![Membership setup - Add parent
  product](https://cdn.juo.io/content-uploads/membership_add_parent_10994305ee.png)
</Frame>
...
<Frame caption="Add your Membership product to a subscription plan">
  ![Membership setup - Add
  new](https://cdn.juo.io/content-uploads/membership_plan_b2115c13f0.png)
</Frame>
...
<Frame>
  ![Membership setup - Parent product
  variants](https://cdn.juo.io/content-uploads/membership_variants_f697619bf7.png)
</Frame>

### Add more subscription plans

The next step is to set up a separate subscription plan for each of the options.
...
<Frame>
  ![Subscription plan setup - Membership
  tiers](https://cdn.juo.io/content-uploads/membership_variants_selling_plan_3b85b7b6ea.png)
</Frame>
...
<Frame>
  ![Shopify inventory - Membership
  plans](https://cdn.juo.io/content-uploads/membership_variants_purchase_options_85f1620795.png)
</Frame>
...
<Frame>
  ![Membership page - Product
  variants](https://cdn.juo.io/content-uploads/membership_variants_product_ba1a89e4b9.png)
</Frame>

## Set a Membership customer segment

The benefits that come with a Membership are restricted to just the customers who have an active Membership. That’s why you need to create a customer segment for Membership owners first. You can do this in Shopify, under **Customers** > **Customer segments**.

Name your segment “Membership” and use filter: **customer_tags CONTAINS ‘membership_active’**

<Frame caption="Use membership_active tag to set up the segment">
  ![Membership setup - Segment
  creation](https://cdn.juo.io/content-uploads/membership_segment_b8093fcfa9.png)
</Frame>

## Set up the benefits

Memberships in Juo let you offer various additional benefits, such as free shipping or discounts on selected products. You can set up the benefits under Discounts in Shopify.
...
<Frame caption="Specify the details of your Membership benefit">
  ![Membership setup - Discount
  code](https://cdn.juo.io/content-uploads/membership_discount_1e3361f6f9.png)
</Frame>
...
Now’s the time to adjust the other details of the discount, such as the Purchase type (one-time, subscription, or both), minimum price threshold, Combinations with other discounts — all depending on your specific Membership offering.

<Frame caption="Apply the discount to your Members only">
  ![Membership setup - Apply discount to Membership
  segment](https://cdn.juo.io/content-uploads/membership_discount_segment_211aec41e9.png)
</Frame>
...
Below you'll find the code you need to place in your theme.liquid template (Remember that you need to adjust the script to match the coupon code settings you’ve specified earlier).
