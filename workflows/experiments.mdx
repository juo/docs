...
Experiments (A/B tests) let you **compare two or more versions of a workflow path** and see which one performs better for your business goal (e.g. reduce cancellations, increase renewals, recover failed payments).
