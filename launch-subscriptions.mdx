...
[Email notifications](https://juo.io/docs/notifications) settings let you customize emails that your customers receive during the different stages of their subscription. You are free to modify the text of these emails, as well as the translations. All emails include the subscription preview and a link to managing the subscription.
