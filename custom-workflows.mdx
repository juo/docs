...
Once you change the box status to **Active**, it will become available to your customers. For now, you can leave it Inactive — just click the _Save_ button to proceed with the box creation.

![]()

<Frame caption="Choose the parent product and name for your Custom workflow">
  ![Dynamic box setup - Box
