...
Next, it’s time decide to which cycles you want the discount to apply. (Refer back to the [product section above](/guides/creating-subscription-plan#free-product) for more details on how the cycle selection works.
