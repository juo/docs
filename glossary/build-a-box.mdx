...
A type of [subscription box](/glossary/subscription-box) that allows the customer to select a number of items from the merchant’s stock and create their own, personalized box with them. Depending on the options provided by merchants, customers can purchase their boxes one time or add them to a [subscription](/glossary/subscription).
...
Build-a-box is a great tool for personalization that merchants can use to increase customer loyalty and their [lifetime value](/glossary/lifetime-value). Apart from personalization itself that allows customers to adjust the volume and type of items in their order to their needs, merchants have a number of tools at their disposal that encourage the customers to add more items to their boxes and retain their subscription for longer:
...
- [dynamic boxes](/glossary/dynamic-boxes) that allow for periodic switching of the box content, which keeps the customers engaged
