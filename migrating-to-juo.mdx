...
Start by setting up Juo Subscriptions on your store. Use our [Getting Started guide](https://juo.io/installing-the-app) to prepare your store for launch and migration.

1. [Install Juo Subscriptions](https://juo.io/installing-the-app) from the Shopify App Store.
2. [Recreate your subscription plans in Juo](https://juo.io/guides/creating-subscription-plan), matching the structure of your current offerings.
