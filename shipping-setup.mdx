...
More advanced shipping rules are possible. You can reward your subscribers with free shipping after X order using [Extras](https://juo.io/extras). Subscription experiences like [Build-a-Box](https://juo.io/adding-build-a-box) or [Custom Workflows](https://juo.io/custom-workflows) also have their own Shipping settings.
