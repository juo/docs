...
[Build-a-box](https://juo.io/guides/adding-build-a-box) is a primarly forntend experience where customers can build their own subscription box and earn rewards based on their order size.
