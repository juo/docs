...
Once you save the template, the widget will show on all your products with subscription plans. You can customize the widget in Theme Editor using [settings provided by Juo](https://juo.io/docs/customizing-juo-subscription-widget).
